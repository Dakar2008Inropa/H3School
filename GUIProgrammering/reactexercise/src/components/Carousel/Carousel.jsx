    ...
    return (
        <section className="carousel" aria-label="Image carousel">
            <div className="carousel__toolbar">
                <label className="carousel__label" htmlFor="transitionSelect">Transition</label>
                <select
                    id="transitionSelect"
            ...
            >
                <div
                    ...
                    style={effect === "slide" ? { transform: `translateX(-${index * 100}%)` } : undefined}
                >
                    {images.map((src, i) => (
                        <div
                            key={src}
            ...
            <div className="carousel__controls">
                <button type="button" className="carousel__btn" onClick={goPrev} aria-label="Previous">
                    ‹
                </button>
                ...
                <button type="button" className="carousel__btn" onClick={goNext} aria-label="Next">
                    ›
                </button>
            </div>
        </section>
